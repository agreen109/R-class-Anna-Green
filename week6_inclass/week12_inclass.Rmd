...
```{r}
myras <- terra::rast("../week6_inclass/ts_2016.1007_1013.L4.LCHMP3.CIcyano.MAXIMUM_7day.tif")
```
...
3. Zonal operations are similar to focal operations, but the surrounding pixel grid on which new values are computed can have irregular sizes and shapes, defined by a vector file
