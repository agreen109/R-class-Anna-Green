...
a<-sf::read_sf("erie_raster_ex/bounds/bb_erie_islands.shp")
b<-sf::read_sf("erie_raster_ex/bounds/bb_erie_large.shp")
c<-sf::read_sf("erie_raster_ex/bounds/bb_erie_maumee.shp")
d<-sf::read_sf("erie_raster_ex/bounds/bb_erie_sandusky_plus.shp")
e<-sf::read_sf("erie_raster_ex/bounds/bb_erie_sandusky.shp")
f<-sf::read_sf("erie_raster_ex/bounds/bb_erie_west_sister.shp")

shapefiles<-dplyr::bind_rows(a,b,c,d,e,f)
...
sf::st_transform(all_aois, crs = 32617)
aoi_vec<-terra::vect(all_aois)
area_int <- terra::extract(four_rasters[[4]], all_aois, 
...
The analysis workflow in this lab was different then working with vector data because 
