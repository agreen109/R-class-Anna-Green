...
sixth<-sf::read_sf("erie_raster_ex/bounds/bb_erie_west_sister.shp")
...
all_aois <- sf::st_transform(shapefiles, crs = 32617)
glimpse(all_aois)
sf::st_make_valid(all_aois)
...
area_interest <- terra::extract(combined_data, all_aois, 
