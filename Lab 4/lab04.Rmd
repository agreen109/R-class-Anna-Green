...
shapefiles_needed<-lapply(list.files(path="erie_raster_ex/bounds", pattern="\\.shp$",full.names=TRUE),
                         sf::read_sf)

combinedAOI<-dplyr::bind_rows(shapefiles_needed)
glimpse(combinedAOI)
```
...
print(combined_data)
print(mean_CI)
extracted_df<-terra::extract(mean_CI,combinedAOI)
