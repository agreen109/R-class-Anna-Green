...
StreamB <- sf::st_buffer(streams.303d, dist = 1000)
StreamB <- sf::st_intersection(oh_parks, StreamB)
tm_shape(oh_counties) + tm_polygons()+
tm_shape(oh_streams)+tm_polygons(fill="green")+
tm_shape(StreamB) + tm_polygons(fill="red")
  
StreamB <- sf::st_buffer(streams.303d, dist = 1000)
StreamB <- sf::st_intersection(oh_parks, StreamB)
tm_shape(oh_counties) + tm_polygons()+
tm_shape(oh_streams)+tm_polygons(fill="green")+
tm_shape(StreamB) + tm_polygons(fill="FEATTYPE")
